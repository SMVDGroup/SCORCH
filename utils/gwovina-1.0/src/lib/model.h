...
struct model {
	...
	sz num_my_flex_pairs() const { return my_flex_pairs.size(); }
	...
	fl eval_without_ligand(                            const precalculate& p,                  const vec& v, const conf& c);
	...
	interacting_pairs my_flex_pairs;
	rotamer rotamers;
	atomv atoms; // movable, inflex
	//interacting_pairs ligand_flex_pairs;
private:
