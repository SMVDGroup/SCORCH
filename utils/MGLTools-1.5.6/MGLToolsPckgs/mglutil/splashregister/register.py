...
# $Author: annao $
# $Header: /opt/cvs/python/packages/share1.5/mglutil/splashregister/register.py,v 1.21.2.6 2014/09/16 23:20:40 annao Exp $
# $Date: 2014/09/16 23:20:40 $
# $Id: register.py,v 1.21.2.6 2014/09/16 23:20:40 annao Exp $
