...
#########################################################################
#
# $Header: /opt/cvs/python/packages/share1.5/ViewerFramework/VF.py,v 1.205.2.6 2014/09/16 23:00:59 annao Exp $
#
# $Id: VF.py,v 1.205.2.6 2014/09/16 23:00:59 annao Exp $
#
...
"""
    ...
    def startupDirPref_cb(self, name, old, new):
        if not os.path.isdir(new):
            if not hasattr(self,'setUserPreference') or not hasattr(self.setUserPreference, 'form'): return
